...
if(!file.exists("full-list-of-bad-words_text-file_2022_05_05.txt")){
  download.file("https://www.freewebheaders.com/download/files/full-list-of-bad-words_text-file_2022_05_05.zip",destfile="full-list-of-bad-words_text-file_2022_05_05.zip",mode = "wb")
}
...
profanewords <- "./full-list-of-bad-words_text-file_2022_05_05.txt"
